...
<div class="row">
	<div class="container">
            <div class="col-xs-12 col-md-6 col-md-offset-3 datos formulario formulario__top">
                <div class="col-xs-12">              
                    <form action="confirmar.php" class="" method="POST" id="formulario">
